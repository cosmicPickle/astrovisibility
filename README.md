...
- **View All Targets:** Search and filter the catalogue. Targets are ranked mainly by usable visible duration and show every visible interval. Selecting one returns to the positioned target in Sky View.
